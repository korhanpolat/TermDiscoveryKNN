...
def evaluate_discovery(tderunfile, TDEROOT, SOURCE, outdir, jobs=1, dataset='phoenix', seq_names=None, cnf=None):
    ...
    os.chdir(sys.path[0])
    cmd = '{} {} {} {} {} {} {} {} {}'.format(tderunfile, TDEROOT, outdir, dataset, 
...
def discovery_pipeline(feats_dict, params):
    ...
    scores = evaluate_discovery(params['eval']['tderunfile'], params['eval']['TDEROOT'], params['eval']['TDESOURCE'], 
...
def run_exp(feats_dict, params, genname=False):
    ''' wraps fixed_coverage experiment, by assigning an experiment name '''

    if genname: params['expname'] = gen_expname(params)
